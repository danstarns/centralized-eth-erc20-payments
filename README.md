...
This project used [Neo4j GraphQL OGM](https://neo4j.com/docs/graphql-manual/current/ogm/) to interact with Neo4j. Here are the following GraphQL definitions for the above model:
...
type User {
  ...
  withdrawals: [Withdrawal]
    @relationship(type: "HAS_WITHDRAWAL", direction: OUT)
  balance: Int
    @cypher(
      statement: """
      CALL {
